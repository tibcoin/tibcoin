...
uint256 hashGenesisBlock("0x7bda54806f19f30493a54b543e473a0b4449f873c05d57f43159a853adfa2fd5");
...
static const int64 nTargetSpacing = 150; // TiBCoin: 2.5 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb106c1e4cc97ba8ef3034a42bdb802b8a29727ad0d85320bd7e620152d03df52");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Former Trump Campaign Chief Is Indicted";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1509440400; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 845998;

        if (fTestNet)
        {
            block.nTime    = 1509156000;
            block.nNonce   = 1590338;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1b6cbe45e2484043075e8721f21172ab71886754221700c46f18a9a76c53e58a"));
